...
library(dplyr)
library(sp)
load('/Users/yeyejiang/Documents/GitHub/Spring2019-Proj2-grp11/output/shape.RData')
...
nbhd<-function(ll){
  ...
  proj4string(ll_spdf) <- proj4string(nyc_neighborhoods)
  match<-over(ll_spdf, nyc_neighborhoods)
  return(match[,c(1,3)])
}
...
colnames(pickupnbhd)%>%c('PUnbhd','PUnbhdBorough')
