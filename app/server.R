...
read_csv('output/AirportSummarized/JFK_count_seperated')
read_csv('output/AirportSummarized/JFK_FPD_seperated')
read_csv('output/AirportSummarized/NWK_count_seperated')
read_csv('output/AirportSummarized/NWK_FPD_seperated')
read_csv('output/AirportSummarized/LGA_count_seperated')
read_csv('output/AirportSummarized/LGA_FPD_seperated')

# names of each borough. subdat is transformed shape1 file
rownames(count_result) = subdat@data$NTACode

# removal of subway data
...
shinyServer(function(input, output,session) { 
  ...
  output$map <- renderLeaflet({
    ...
    # REMOVING CLUSTER BECAUSE STUPID
